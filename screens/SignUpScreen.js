                    ...
                    <View style={{flex: 1, justifyContent:"center", alignItems: 'center'}}>
                            <View>
                                <View style={{ shadowColor: '#171717',shadowOffset: {width: -2, height: 4},shadowOpacity: 0.2,shadowRadius: 3,backgroundColor: '#ffffff76', paddingLeft: '14%', paddingRight: '14%', borderRadius: 8}}>
                                    ...
                                    <TextInput style={{fontSize: 19, padding: 10, fontWeight: 'bold', borderBottomWidth: 1, marginBottom: '4%', borderRadius: 3}} type="text" onChangeText={e => {inputHandler(e, 'firstName')}} placeholder="Nombre" />
                                    <TextInput style={{fontSize: 19, padding: 10, fontWeight: 'bold', borderBottomWidth: 1, marginBottom: '4%', borderRadius: 3}} type="text" onChangeText={e => {inputHandler(e, 'lastName')}} name="apellido" placeholder="Apellido" />
                                    <TextInput style={{fontSize: 19, padding: 10, fontWeight: 'bold', borderBottomWidth: 1, marginBottom: '4%', borderRadius: 3}} type="number" onChangeText={e => {inputHandler(e, 'age')}} name="age" placeholder="Edad" />
                                    <TextInput style={{fontSize: 19, padding: 10, fontWeight: 'bold', borderBottomWidth: 1, marginBottom: '4%', borderRadius: 3}} type="text" onChangeText={e => {inputHandler(e, 'email')}} name="email" placeholder="E-mail" />
                                    <TextInput style={{fontSize: 19, padding: 10, fontWeight: 'bold', borderBottomWidth: 1, marginBottom: '4%', borderRadius: 3}} onChangeText={e => {inputHandler(e, 'password')}} name="password" placeholder="Contraseña" secureTextEntry={true} />
                                    <TextInput style={{fontSize: 19, padding: 10, fontWeight: 'bold', borderBottomWidth: 1, marginBottom: '4%', borderRadius: 3}} type="url" onChangeText={e => {inputHandler(e, 'userImg')}} name="userImage" placeholder="Imagen de perfil" />
